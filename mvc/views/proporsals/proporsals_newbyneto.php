...
$oTxtDescSubfamilia = new HelperText("Subfamilia_Description",$oMtbPropuesta->get_descripcion_subfamilia(),"Subfamilia");
$oTxtDescSubfamilia->required();
$oTxtDescSubfamilia->readonly();

$oHidCodeSubfamilia = new HelperHidden("detm_Code_SubFamilia",$oMtbPropuesta->get_code_subfamilia());

$oTxtProducto = new HelperText("Producto_Description", $oMtbPropuesta->get_descripcion_producto(), "Producto");
$oTxtProducto->required();
$oTxtProducto->readonly();

$oHidCodeArticulo = new HelperHidden("detm_Code_Articulo",$oMtbPropuesta->get_code_articulo());
...
$oTxtDescSubfamilia->show();
$oHidCodeSubfamilia->show();
$oTxtProducto->show();
$oHidCodeArticulo->show();
$oNumberDto->show();
$oHidValorOld->show();
